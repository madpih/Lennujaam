      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
          <div class="navbar-nav">
            ...
            <a class="nav-link active" aria-current="page" href="airlines.php">Lennufirmad</a>
          </div>
        </div>
      </div>
    </nav>
        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-lg-6 px-5">
                    <h1 class="display-4">Lennufirmad</h1>
                    <p class="fst-italic text-muted">Lennufirma andmete muutmiseks või kustutamiseks vali lennufirma</p><hr>
                    
                </div> 
                <div class="col-lg-6 px-5">
                    <h1 class="display-5">Lennufirmade haldus</h1>
                    <h4 class="text-muted">Uue lennufirma lisamine</h4>
                    <hr>   
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="website" placeholder ="www" required>
                    </div>
                    <div class="mb-3">
                        <label for="phonenumber" class="form-label">Telefon</label>
                        <input type="text" class="form-control" id="phonenumber" placeholder="(+riigikood)" required>
                    </div>                  
